    ...
    <div class="md-card">
		...
		<div class="uk-grid" data-uk-grid-margin >
				...
				<div class="uk-width-medium-1-1">
					...
					<label>Notice Board<span class="req">*</span></label> <br />
		...
		var message=$("#wysiwyg_ckeditor").val();
			...
			if(message!="" )
			{
			   var str = $("form").serialize();
				$.ajax({
					   	url:'<?php echo base_url();?>index.php/admin/save_cms',
						type: 'POST',
						cache:false,
						async: false,
						crossDomain: true,
					    ...
					    success: function(data){
						 ...
						 if(data.success==1)
						 {
						  data_html+='<div class="uk-alert uk-alert-success" data-uk-alert=""><a href="#" class="uk-alert-close uk-close"></a>Notice board updated sucessfully.</div>';
...
function check_if_title_exists(username,pk) {
		$.ajax({
					   	url:'<?php echo base_url();?>index.php/admin/check_title_already_exist',
						type: 'POST',
						cache:false,
						async: false,
						crossDomain: true,
