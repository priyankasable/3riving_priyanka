                ...
                <li>
                    <div class="timeline timeline_small uk-margin-bottom">
                        ...
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content">Deleted post <a href="#"><strong>Est tenetur velit aut culpa incidunt quia ea.</strong></a></div>
                        </div>
                        <div class="timeline_item">
                        ...
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content">
                                New comment on post <a href="#"><strong>Ea non voluptas non quis quis.</strong></a>
                                <div class="timeline_content_addon">
                                    <blockquote>
                                        Qui ratione quaerat ut et vitae vitae et velit ut totam tempora.&hellip;
                                    </blockquote>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <ul class="md-list md-list-addon">
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span class="md-list-heading">Daisy Keeling</span>
                                                <span class="uk-text-small uk-text-muted">Sunt est et laudantium.</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <ul class="md-list md-list-addon chat_users">
                        <li>
                            ...
                            <div class="md-list-content">
                                ...
                                <span class="md-list-heading">Demetris McDermott</span>
                                <span class="uk-text-small uk-text-muted uk-text-truncate">Quasi libero asperiores.</span>
                            </div>
                        </li>
                        <li>
                            <div class="md-list-addon-element">
                            ...
                            <div class="md-list-content">
                                <div class="md-list-action-placeholder"></div>
                                <span class="md-list-heading">Pansy Herman</span>
                                <span class="uk-text-small uk-text-muted uk-text-truncate">Facilis rerum.</span>
                            </div>
                        </li>
                        <li>
                            <div class="md-list-addon-element">
                            ...
                            <div class="md-list-content">
                                <div class="md-list-action-placeholder"></div>
                                <span class="md-list-heading">Eleanore Nader</span>
                                <span class="uk-text-small uk-text-muted uk-text-truncate">Quis rerum.</span>
                            </div>
                        </li>
                        <li>
                            <div class="md-list-addon-element">
                            ...
                            <div class="md-list-content">
                                <div class="md-list-action-placeholder"></div>
                                <span class="md-list-heading">Lorine Altenwerth</span>
                                <span class="uk-text-small uk-text-muted uk-text-truncate">Nobis et.</span>
                            </div>
                        </li>
                    </ul>
